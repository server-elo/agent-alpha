...
sds tools_run(const char *name, cJSON *args, const char *cwd) {
    ...
    /* 1. Core OS, filesystem, shell, and session built-ins */
    ...
    /* 2. Fast O(1) table-driven modular tool registry */
...
cJSON *tools_schema(void) {
    ...
    /* 1. Core tool schemas */
    static const char *core_schemas[] = {
        "{\"type\":\"function\",\"function\":{\"name\":\"execute_powershell\",\"description\":\"Execute PowerShell 7+ via pwsh (pipelines, objects, scripts). macOS.\",\"parameters\":{\"type\":\"object\",\"properties\":{\"command\":{\"type\":\"string\",\"description\":\"PowerShell command or script to run\"}},\"required\":[\"command\"]}}}",
        "{\"type\":\"function\",\"function\":{\"name\":\"execute_bash\",\"description\":\"Run any shell command (open; no sandbox).\",\"parameters\":{\"type\":\"object\",\"properties\":{\"command\":{\"type\":\"string\"}},\"required\":[\"command\"]}}}",
        "{\"type\":\"function\",\"function\":{\"name\":\"read_file\",\"description\":\"Read a file (any path).\",\"parameters\":{\"type\":\"object\",\"properties\":{\"path\":{\"type\":\"string\"}},\"required\":[\"path\"]}}}",
        "{\"type\":\"function\",\"function\":{\"name\":\"write_file\",\"description\":\"Write full file contents (creates parents).\",\"parameters\":{\"type\":\"object\",\"properties\":{\"path\":{\"type\":\"string\"},\"content\":{\"type\":\"string\"}},\"required\":[\"path\",\"content\"]}}}",
        "{\"type\":\"function\",\"function\":{\"name\":\"edit_file\",\"description\":\"Replace unique old_str with new_str in file.\",\"parameters\":{\"type\":\"object\",\"properties\":{\"path\":{\"type\":\"string\"},\"old_str\":{\"type\":\"string\"},\"new_str\":{\"type\":\"string\"}},\"required\":[\"path\",\"old_str\",\"new_str\"]}}}",
        "{\"type\":\"function\",\"function\":{\"name\":\"list_dir\",\"description\":\"List directory entries (any path).\",\"parameters\":{\"type\":\"object\",\"properties\":{\"path\":{\"type\":\"string\"}}}}}",
    ...
    for (int i = 0; core_schemas[i]; i++) {
        cJSON *item = cJSON_Parse(core_schemas[i]);
        if (item) cJSON_AddItemToArray(root, item);
    }

    /* 2. Dynamically add registered modular tool schemas */
    for (int i = 0; g_registered_tools[i]; i++) {
