...
cJSON *tools_schema(void) {
    const char *json =
        ...
        "\"path\":{\"type\":\"string\"}}}}},"
        "{\"type\":\"function\",\"function\":{\"name\":\"grep\",\"description\":\"Fast recursive regex search over files and directories. Structured path:line:text output.\",\"parameters\":{\"type\":\"object\",\"properties\":{\"pattern\":{\"type\":\"string\",\"description\":\"POSIX extended regex to search for\"},\"path\":{\"type\":\"string\",\"description\":\"File or directory to search (default .)\"},\"file_pattern\":{\"type\":\"string\",\"description\":\"Optional glob filter e.g. *.c\"},\"max_results\":{\"type\":\"integer\",\"description\":\"Max results (default 1000)\"}},\"required\":[\"pattern\"]}}},"
